        ...
        <ul class="nav flex-nowrap align-items-center ms-3 fs-5">
            ...
            if (!empty($_SESSION['email1'])) {
                ...
                <div class="login d-flex" style="margin-left: auto;">
                    <div>Вы вошли как &ensp;<?= htmlspecialchars($_SESSION['email1']) ?>.</div>
                    &ensp;
                ...
                <div class="login" style="margin-left: auto;">
                    ...
                    <div><a href="authorization.php">Ввести логин и пароль</a> или <a href="registration.php">Зарегистрироваться</a>
                    </div>
                </div>
                <?php
            }
